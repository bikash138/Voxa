...
function App() {
  ...
  return (
    <div className="flex h-screen bg-gray-950 text-white">
      ...
      <div className="w-16 h-full">
        <div className="flex flex-col items-center justify-between h-full py-6 bg-gray-900 border-r border-gray-800">
          <div className="flex flex-col items-center">
            <div className="w-10 h-10 bg-purple-600 rounded-xl flex items-center justify-center text-white font-bold mb-8">
          ...
          <div className="flex flex-col items-center space-y-6">
            <button className="w-10 h-10 rounded-xl flex items-center justify-center text-gray-400 transition-all duration-200 hover:bg-gray-800 hover:text-red-500">
              <LogOut size={20} />
            </button>
      ...
      <div className="w-full md:w-80 lg:w-96 border-r border-gray-800 bg-gray-900">
        ...
        <div className="h-[calc(100%-73px)] flex flex-col">
          ...
          <div className="p-4 border-t border-gray-800">
            <button className="w-full bg-purple-600 hover:bg-purple-700 text-white rounded-lg py-2 px-4 flex items-center justify-center transition-colors duration-200">
      ...
      {/* Main content area */}
      <div className="flex-1 hidden md:flex bg-gray-950">
        <div className="flex flex-col items-center justify-center h-full text-center px-6">
          ...
          <button className="bg-purple-600 hover:bg-purple-700 text-white rounded-lg py-2 px-6 transition-colors duration-200">
            Create New Room
          </button>
        </div>
      </div>
