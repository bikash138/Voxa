...
export default function page() {
  ...
  return (
        ...
        // <div className="bg-black shadow-xl overflow-hidden min-h-screen md:h-screen">
          <div className="h-[calc(100%-73px)] min-w-fit bg-gray-900 flex flex-col " >
            {/* Chat Header */}
            <div className="flex items-center p-3 justify-between border-b border-gray-800 bg-gray-900">
